  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10 animate-fade-in-up px-2 pb-12">
      ...
      <div className="flex flex-col gap-2 px-2">
        <h1 className="text-4xl font-extrabold tracking-tight text-foreground font-display text-glow">
          Personnel profile
        </h1>
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="glass p-8 rounded-[2.5rem] border-none relative overflow-hidden flex flex-col items-center">
            ...
            >
              ...
              <Avatar className="h-40 w-40 border-4 border-foreground/5 shadow-2xl relative">
                {previewUrl ? (
                  <AvatarImage src={previewUrl} className="object-cover" />
                ) : (
                  <AvatarFallback className="bg-gradient-to-br from-slate-800 to-black text-foreground text-4xl font-black">
                    {user.name.charAt(0)}
                  </AvatarFallback>
                )}
              </Avatar>
              <div className="absolute inset-0 bg-black/60 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 scale-90 group-hover:scale-100">
                <Camera className="text-foreground h-10 w-10 drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]" />
              </div>
              <input
                type="file"
                ref={fileInputRef}
            ...
            <div className="mt-8 text-center space-y-4 w-full">
              <div className="space-y-1">
                <h2 className="text-2xl font-black text-foreground font-display tracking-tight text-glow uppercase">
                  {user.name}
                </h2>
              ...
              <div className="pt-6 border-t border-foreground/5 space-y-4">
                <div className="flex items-center gap-4 text-foreground/40 group hover:text-foreground/70 transition-colors">
                  <div className="h-8 w-8 rounded-lg bg-foreground/5 border border-foreground/10 flex items-center justify-center shrink-0">
          ...
          <form onSubmit={handleUpdateProfile} className="space-y-8">
            ...
            <div className="glass p-8 md:p-10 rounded-[2.5rem] border-none space-y-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-5">
                <UserIcon className="h-32 w-32 text-foreground" />
              </div>
              ...
              <div className="space-y-1 relative">
                ...
                <p className="text-[10px] font-bold text-foreground/20 uppercase tracking-widest ml-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    className="h-12 bg-foreground/5 border-foreground/10 rounded-2xl text-foreground placeholder:text-foreground/20 focus-visible:ring-cyan-500/30"
                  />
                </div>
                <div className="space-y-3">
                  <Label className="text-[10px] font-bold uppercase tracking-widest text-foreground/40 ml-1">
                    Comms Interface (Email)
                  </Label>
                  <Input
                    id="email"
                    type="email"
            ...
            <div className="glass p-8 md:p-10 rounded-[2.5rem] border-none space-y-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-5">
                <Lock className="h-32 w-32 text-foreground" />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    placeholder="••••••••"
                    className="h-12 bg-foreground/5 border-foreground/10 rounded-2xl text-foreground placeholder:text-foreground/20 focus-visible:ring-blue-500/30"
                  />
                </div>
                <div className="space-y-3">
                  <Label className="text-[10px] font-bold uppercase tracking-widest text-foreground/40 ml-1">
            ...
            <div className="flex justify-end pt-4">
              <Button
                type="submit"
                disabled={loading}
                className="bg-gradient-to-r from-cyan-600 to-blue-500 hover:from-cyan-500 hover:to-blue-400 text-foreground font-black rounded-2xl h-14 px-12 shadow-lg shadow-cyan-500/20 transition-all hover:scale-[1.02] active:scale-95 group"
              >
