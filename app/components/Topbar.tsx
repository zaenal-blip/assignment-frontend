...
export function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center glass border-b border-border/40 px-4 tv:h-24 tv:px-10">
      ...
      <div className="mx-auto hidden max-w-md flex-1 px-4 md:block">
        <div className="relative group">
          ...
          <Input
            ...
            className="h-9 w-full bg-background/50 backdrop-blur-sm pl-10 placeholder:text-muted-foreground transition-all border-border/50 focus-visible:ring-1 focus-visible:ring-primary/50"
          />
        </div>
      </div>
      ...
      <div className="ml-auto flex items-center gap-2 tv:gap-6">
        ...
        <div className="hidden items-center gap-2 rounded-full bg-background/50 border border-border/40 px-3 py-1.5 text-xs font-medium text-muted-foreground lg:flex">
        ...
        <div className="flex items-center gap-1 tv:gap-3">
          ...
          <div className="h-6 w-px bg-border/40 tv:h-10 mx-1 lg:block hidden" />
          <UserDropdown
            user={
              currentUser ?? {
                id: "",
